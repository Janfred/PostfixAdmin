...
class ServerHandler extends PFAHandler {
    ...
    protected function initStruct() {
        ...
        $this->struct=array(
           ...
           '_can_edit'      => pacol(   0,        0, 1, 'int',  '',              '', 0, '', 0, 1, Config::bool('multiple_servers') && $this->is_superadmin . 'as _can_edit' ),
           '_can_delete'    => pacol(   0,        0, 1, 'int',  '',              '', 0, '', 0, 1, Config::bool('multiple_servers') && $this->is_superadmin . 'as _can_delete' ),
        );
    }
